...
# tf.random.get_global_generator or tf.random.Generator to generate the RNG.
# The legacy behavior is to use stateful tf.random ops.
...
class RandomGenerator:
  ...
  def make_legacy_seed(self):
    """Create a new seed for the stateful ops to use.
